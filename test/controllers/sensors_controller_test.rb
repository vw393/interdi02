...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { descr: @sensor.descr, manufacturer_id: @sensor.manufacturer_id, name: @sensor.name, pn: @sensor.pn, sensor_family_id: @sensor.sensor_family_id, size: @sensor.size }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { descr: @sensor.descr, manufacturer_id: @sensor.manufacturer_id, name: @sensor.name, pn: @sensor.pn, sensor_family_id: @sensor.sensor_family_id, size: @sensor.size }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
